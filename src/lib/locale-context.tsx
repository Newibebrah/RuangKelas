...
const localeData: Record<Locale, Messages> = {
  id: {
    ...
    nav: { dashboard: "Dashboard", tugas: "Tugas", materi: "Materi", kas: "Kas", anggota: "Anggota", jadwal: "Jadwal", pengurus: "Pengurus", riwayat: "Riwayat", kelolaKas: "Kelola Kas", kelolaData: "Kelola Data", beranda: "Beranda", myClasses: "Kelas Saya" },
  ...
  en: {
    ...
    nav: { dashboard: "Dashboard", tugas: "Assignments", materi: "Materials", kas: "Finance", anggota: "Members", jadwal: "Schedule", pengurus: "Management", riwayat: "History", kelolaKas: "Manage Finance", kelolaData: "Manage Data", beranda: "Home", myClasses: "My Classes" },
